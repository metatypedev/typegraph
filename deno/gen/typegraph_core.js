  ...
  switch (variant6.tag) {
    case 'ok': {
      ...
      for (let i = 0; i < vec4.length; i++) {
        const e = vec4[i];
        const base = result4 + i * 8;const ptr3 = utf8Encode(e, realloc0, memory0);
...
function initTypegraph(arg0) {
  ...
  const {name: v1_0, dynamic: v1_1, folder: v1_2, path: v1_3, prefix: v1_4, secrets: v1_5, cors: v1_6, auths: v1_7, rate: v1_8 } = arg0;
  ...
  for (let i = 0; i < vec10.length; i++) {
    const e = vec10[i];
    const base = result10 + i * 8;const ptr9 = utf8Encode(e, realloc0, memory0);
  ...
  const {allowOrigin: v11_0, allowHeaders: v11_1, exposeHeaders: v11_2, allowMethods: v11_3, allowCredentials: v11_4, maxAgeSec: v11_5 } = v1_6;
  const vec13 = v11_0;
  const len13 = vec13.length;
  const result13 = realloc0(0, 0, 4, len13 * 8);
  for (let i = 0; i < vec13.length; i++) {
    const e = vec13[i];
    const base = result13 + i * 8;const ptr12 = utf8Encode(e, realloc0, memory0);
  ...
  for (let i = 0; i < vec15.length; i++) {
    const e = vec15[i];
    const base = result15 + i * 8;const ptr14 = utf8Encode(e, realloc0, memory0);
  ...
  for (let i = 0; i < vec17.length; i++) {
    const e = vec17[i];
    const base = result17 + i * 8;const ptr16 = utf8Encode(e, realloc0, memory0);
  ...
  for (let i = 0; i < vec19.length; i++) {
    const e = vec19[i];
    const base = result19 + i * 8;const ptr18 = utf8Encode(e, realloc0, memory0);
  ...
  for (let i = 0; i < vec28.length; i++) {
    const e = vec28[i];
    const base = result28 + i * 20;const {name: v21_0, protocol: v21_1, authData: v21_2 } = e;
    ...
    for (let i = 0; i < vec27.length; i++) {
      const e = vec27[i];
      const base = result27 + i * 16;const [tuple24_0, tuple24_1] = e;
  ...
  if (variant32 === null || variant32=== undefined) {
    ...
    const {windowLimit: v29_0, windowSec: v29_1, queryLimit: v29_2, contextIdentifier: v29_3, localExcess: v29_4 } = e;
...
function withInjection(arg0) {
  ...
  const len1 = utf8EncodedLen;
  const ret = exports1['metatype:typegraph/core#with-injection'](toUint32(v0_0), ptr1, len1);
  let variant3;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant3= {
...
function proxyb(arg0) {
  ...
  const ret = exports1['metatype:typegraph/core#proxyb'](ptr1, len1, result5, len5);
  let variant7;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant7= {
...
function integerb(arg0, arg1) {
  ...
  const {min: v1_0, max: v1_1, exclusiveMinimum: v1_2, exclusiveMaximum: v1_3, multipleOf: v1_4, enumeration: v1_5 } = arg0;
  const variant2 = v1_0;
  ...
  if (variant16 === null || variant16=== undefined) {
    ...
    for (let i = 0; i < vec15.length; i++) {
      const e = vec15[i];
      const base = result15 + i * 16;const [tuple12_0, tuple12_1] = e;
...
function stringb(arg0, arg1) {
  const ptr0 = realloc0(0, 0, 4, 80);
  const {min: v1_0, max: v1_1, format: v1_2, pattern: v1_3, enumeration: v1_4 } = arg0;
  const variant2 = v1_0;
  if (variant2 === null || variant2=== undefined) {
    dataView(memory0).setInt8(ptr0 + 0, 0, true);
  } else {
  ...
  if (variant10 === null || variant10=== undefined) {
    ...
    for (let i = 0; i < vec9.length; i++) {
      const e = vec9[i];
      const base = result9 + i * 8;const ptr8 = utf8Encode(e, realloc0, memory0);
  ...
  if (variant18 === null || variant18=== undefined) {
    ...
    for (let i = 0; i < vec17.length; i++) {
      const e = vec17[i];
      const base = result17 + i * 16;const [tuple14_0, tuple14_1] = e;
...
function arrayb(arg0, arg1) {
  ...
  if (variant11 === null || variant11=== undefined) {
    ...
    for (let i = 0; i < vec10.length; i++) {
      const e = vec10[i];
      const base = result10 + i * 16;const [tuple7_0, tuple7_1] = e;
  ...
  const ret = exports1['metatype:typegraph/core#arrayb'](toUint32(v0_0), variant1_0, variant1_1, variant2_0, variant2_1, variant3_0, variant3_1, variant6_0, variant6_1, variant6_2, variant11_0, variant11_1, variant11_2, v4_2 ? 1 : 0);
  let variant13;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant13= {
...
function unionb(arg0, arg1) {
  ...
  if (variant9 === null || variant9=== undefined) {
    ...
    for (let i = 0; i < vec8.length; i++) {
      const e = vec8[i];
      const base = result8 + i * 16;const [tuple5_0, tuple5_1] = e;
...
function structb(arg0, arg1) {
  ...
  for (let i = 0; i < vec3.length; i++) {
    const e = vec3[i];
    const base = result3 + i * 12;const [tuple1_0, tuple1_1] = e;
  ...
  const ret = exports1['metatype:typegraph/core#structb'](result3, len3, v0_1 ? 1 : 0, variant4_0, variant4_1, variant5_0, variant5_1, variant8_0, variant8_1, variant8_2, variant13_0, variant13_1, variant13_2, v6_2 ? 1 : 0);
  let variant15;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant15= {
...
function funcb(arg0) {
  ...
  const ret = exports1['metatype:typegraph/core#funcb'](toUint32(v0_0), toUint32(v0_1), toUint32(v0_2));
  let variant2;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant2= {
...
function withPolicy(arg0) {
  ...
  for (let i = 0; i < vec7.length; i++) {
    const e = vec7[i];
    const base = result7 + i * 36;const variant6 = e;
    switch (variant6.tag) {
      case 'simple': {
        const e = variant6.val;
  ...
  const ret = exports1['metatype:typegraph/core#with-policy'](toUint32(v0_0), result7, len7);
  let variant9;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant9= {
...
function expose(arg0, arg1, arg2) {
  ...
  if (variant12 === null || variant12=== undefined) {
    ...
    for (let i = 0; i < vec11.length; i++) {
      const e = vec11[i];
      const base = result11 + i * 36;const variant10 = e;
  ...
  const ret = exports1['metatype:typegraph/core#expose'](result2, len2, result4, len4, variant12_0, variant12_1, variant12_2);
  let variant14;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant14= {
...
function registerDenoFunc(arg0, arg1) {
  ...
  for (let i = 0; i < vec3.length; i++) {
    const e = vec3[i];
    const base = result3 + i * 8;const ptr2 = utf8Encode(e, realloc0, memory0);
    const len2 = utf8EncodedLen;
    dataView(memory0).setInt32(base + 4, len2, true);
    dataView(memory0).setInt32(base + 0, ptr2, true);
  }
...
function importDenoFunction(arg0, arg1) {
  ...
  const ret = exports1['metatype:typegraph/runtimes#import-deno-function'](ptr1, len1, ptr2, len2, result4, len4, variant5_0, variant5_1);
  let variant7;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant7= {
...
function httpRequest(arg0, arg1) {
  ...
  const {method: v3_0, path: v3_1, contentType: v3_2, headerPrefix: v3_3, queryFields: v3_4, renameFields: v3_5, bodyFields: v3_6, authTokenField: v3_7 } = arg1;
  const val4 = v3_0;
  let enum4;
  switch (val4) {
    case 'get': {
  ...
  if (variant12 === null || variant12=== undefined) {
    ...
    for (let i = 0; i < vec11.length; i++) {
      const e = vec11[i];
      const base = result11 + i * 8;const ptr10 = utf8Encode(e, realloc0, memory0);
      const len10 = utf8EncodedLen;
      dataView(memory0).setInt32(base + 4, len10, true);
      dataView(memory0).setInt32(base + 0, ptr10, true);
    }
  ...
  if (variant17 === null || variant17=== undefined) {
    ...
    for (let i = 0; i < vec16.length; i++) {
      const e = vec16[i];
      const base = result16 + i * 16;const [tuple13_0, tuple13_1] = e;
...
function fromPythonModule(arg0, arg1) {
  ...
  const ptr3 = utf8Encode(v2_1, realloc0, memory0);
  const len3 = utf8EncodedLen;
  const ret = exports1['metatype:typegraph/runtimes#from-python-module'](toUint32(v0_0), variant1_0, variant1_1, toUint32(v2_0), ptr3, len3);
  let variant5;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant5= {
...
function fromPythonImport(arg0, arg1) {
  ...
  for (let i = 0; i < vec5.length; i++) {
    const e = vec5[i];
    const base = result5 + i * 8;const ptr4 = utf8Encode(e, realloc0, memory0);
    const len4 = utf8EncodedLen;
    dataView(memory0).setInt32(base + 4, len4, true);
    dataView(memory0).setInt32(base + 0, ptr4, true);
  }
...
function registerRandomRuntime(arg0) {
  ...
  const ret = exports1['metatype:typegraph/runtimes#register-random-runtime'](toUint32(v0_0), variant2_0, variant2_1, variant2_2);
  let variant4;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant4= {
...
function registerWasmedgeRuntime() {
  const ret = exports1['metatype:typegraph/runtimes#register-wasmedge-runtime']();
  let variant1;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant1= {
...
function fromWasiModule(arg0, arg1) {
  ...
  const len4 = utf8EncodedLen;
  const ret = exports1['metatype:typegraph/runtimes#from-wasi-module'](toUint32(v0_0), variant1_0, variant1_1, ptr3, len3, ptr4, len4);
  let variant6;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant6= {
...
function prismaLink(arg0) {
  const {targetType: v0_0, relationshipName: v0_1, foreignKey: v0_2, targetField: v0_3, unique: v0_4 } = arg0;
  const variant2 = v0_1;
  let variant2_0;
  let variant2_1;
  let variant2_2;
...
function registerTemporalRuntime(arg0) {
  ...
  const ptr2 = utf8Encode(v0_1, realloc0, memory0);
  const len2 = utf8EncodedLen;
  const ret = exports1['metatype:typegraph/runtimes#register-temporal-runtime'](ptr1, len1, ptr2, len2);
  let variant4;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant4= {
...
function generateTemporalOperation(arg0, arg1) {
  ...
  switch (variant4.tag) {
    ...
    default: {
      throw new TypeError('invalid variant specified for TemporalOperationType');
    }
  }
  const ret = exports1['metatype:typegraph/runtimes#generate-temporal-operation'](toUint32(arg0), variant2_0, variant2_1, variant2_2, variant3_0, variant3_1, variant4_0);
  let variant6;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant6= {
...
function genApplyb(arg0, arg1) {
  ...
  for (let i = 0; i < vec7.length; i++) {
    const e = vec7[i];
    const base = result7 + i * 24;const {path: v1_0, value: v1_1 } = e;
    const vec3 = v1_0;
    const len3 = vec3.length;
    const result3 = realloc0(0, 0, 4, len3 * 8);
    for (let i = 0; i < vec3.length; i++) {
  ...
  const ret = exports1['metatype:typegraph/utils#gen-applyb'](toUint32(arg0), result7, len7);
  let variant9;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant9= {
...
const $init = (async() => {
  ...
  const module1 = base64Compile('');
  const module2 = base64Compile('AGFzbQEAAAABDwJgBX9/f39/AGADf39/AAIaAwABMAAAAAExAAEACCRpbXBvcnRzAXABAgIJCAEAQQALAgABAC4JcHJvZHVjZXJzAQxwcm9jZXNzZWQtYnkBDXdpdC1jb21wb25lbnQGMC4xMy4wABwEbmFtZQAVFHdpdC1jb21wb25lbnQ6Zml4dXBz');
  ...
  postReturn1 = exports1['cabi_post_metatype:typegraph/core#finalize-typegraph'];
  ...
  postReturn17 = exports1['cabi_post_metatype:typegraph/core#register-context-policy'];
  postReturn18 = exports1['cabi_post_metatype:typegraph/core#expose'];
  postReturn19 = exports1['cabi_post_metatype:typegraph/runtimes#register-deno-func'];
  postReturn20 = exports1['cabi_post_metatype:typegraph/runtimes#get-predefined-deno-func'];
  postReturn21 = exports1['cabi_post_metatype:typegraph/runtimes#import-deno-function'];
  postReturn22 = exports1['cabi_post_metatype:typegraph/runtimes#register-graphql-runtime'];
  postReturn23 = exports1['cabi_post_metatype:typegraph/runtimes#graphql-query'];
  postReturn24 = exports1['cabi_post_metatype:typegraph/runtimes#graphql-mutation'];
  postReturn25 = exports1['cabi_post_metatype:typegraph/runtimes#register-http-runtime'];
  postReturn26 = exports1['cabi_post_metatype:typegraph/runtimes#http-request'];
  postReturn27 = exports1['cabi_post_metatype:typegraph/runtimes#register-python-runtime'];
  postReturn28 = exports1['cabi_post_metatype:typegraph/runtimes#from-python-lambda'];
  postReturn29 = exports1['cabi_post_metatype:typegraph/runtimes#from-python-def'];
  postReturn30 = exports1['cabi_post_metatype:typegraph/runtimes#from-python-module'];
  postReturn31 = exports1['cabi_post_metatype:typegraph/runtimes#from-python-import'];
  postReturn32 = exports1['cabi_post_metatype:typegraph/runtimes#register-random-runtime'];
  postReturn33 = exports1['cabi_post_metatype:typegraph/runtimes#create-random-mat'];
  postReturn34 = exports1['cabi_post_metatype:typegraph/runtimes#register-wasmedge-runtime'];
  postReturn35 = exports1['cabi_post_metatype:typegraph/runtimes#from-wasi-module'];
  postReturn36 = exports1['cabi_post_metatype:typegraph/runtimes#register-prisma-runtime'];
  postReturn37 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-find-unique'];
  postReturn38 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-find-many'];
  postReturn39 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-find-first'];
  postReturn40 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-aggregate'];
  postReturn41 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-count'];
  postReturn42 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-group-by'];
  postReturn43 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-create-one'];
  postReturn44 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-create-many'];
  postReturn45 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-update-one'];
  postReturn46 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-update-many'];
  postReturn47 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-upsert-one'];
  postReturn48 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-delete-one'];
  postReturn49 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-delete-many'];
  postReturn50 = exports1['cabi_post_metatype:typegraph/runtimes#prisma-link'];
  postReturn51 = exports1['cabi_post_metatype:typegraph/runtimes#register-temporal-runtime'];
  postReturn52 = exports1['cabi_post_metatype:typegraph/runtimes#generate-temporal-operation'];
...
export { core, runtimes, utils, core as 'metatype:typegraph/core', runtimes as 'metatype:typegraph/runtimes', utils as 'metatype:typegraph/utils' }